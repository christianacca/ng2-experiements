 ...
 * reuse-strategy.ts
 * by corbfon 1/6/17
 * (source: http://stackoverflow.com/questions/41280471/how-to-implement-routereusestrategy-shoulddetach-for-specific-routes-in-angular)
 * todo: fix for child routes; for possible fix see:
 * https://github.com/manfredsteyer/angular-2-reuse-strategy-sample/commit/6ac43c7e96cd507dd8dcc4a7a89b760aba6c1844)
 */
...
export class CustomReuseStrategy implements RouteReuseStrategy {
     ...
     * @param route This is, at least as I understand it, the route that the user is currently on, and we would like to know if
     * we want to store it
    ...
    shouldAttach(route: ActivatedRouteSnapshot): boolean {
        ...
        if (canAttach) {
            ...
            console.log('deciding to attach...', route, 'does it match?',
                this.storedRoutes[route.routeConfig.path].snapshot, 'return: ', paramsMatch && queryParamsMatch);
     ...
     * have put this function in vanilla JS already
